...
const mockDinners = [
  {
    ...
    distance: "0.2 mi",
    description: "Casual taco night with neighborhood connections.",
  ...
  },
  {
    ...
    gatheringMode: "adults" as const,
    distance: "0.1 mi",
    description: "Traditional Italian family dinner with authentic recipes.",
    joinDeadline: "October 15, 2025",
    isSampleData: true,
    isFull: false
  },
  {
    ...
    gatheringMode: "families" as const,
    distance: "0.3 mi",
    description: "Fun family activities and community building.",
    joinDeadline: "October 15, 2025",
    isSampleData: true,
    isFull: false
  }
