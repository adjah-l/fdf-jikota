      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {fiveCsData.map((item) => (
            <div
              key={item.id}
              className="group relative bg-card border rounded-xl p-6 text-center transition-all duration-300 hover:shadow-lg hover:scale-105"
              onMouseEnter={() => setHoveredCard(item.id)}
              onMouseLeave={() => setHoveredCard(null)}
            >
              {/* Icon Container */}
              <div className="mx-auto mb-4 w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center transition-all duration-300">
        ...
        <div className="text-center mt-16">
          ...
          <button className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors duration-300">
            Join a Group Today
