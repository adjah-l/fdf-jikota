...
CREATE INDEX idx_external_batch_email_configs_batch_id ON public.external_batch_email_configs(batch_id);
CREATE INDEX idx_external_matching_policies_batch_id ON public.external_matching_policies(batch_id);
CREATE INDEX idx_external_groups_batch_id ON public.external_groups(batch_id);
CREATE INDEX idx_external_groups_is_reverted ON public.external_groups(is_reverted);